...
class BorrowPage extends StatefulWidget {
  BorrowPage({Key ?key, this.title}) : super(key: key);
...
class _BorrowPageState extends State<BorrowPage> {
  ...
  final itemID_controller = TextEditingController();
  ...
  Widget _submitButton() {
    return InkWell(
        onTap: () async {
          ...
          item_rent(itemID_controller.text,
  ...
  Widget _ItemWidget() {
    return Column(
      children: <Widget>[
        _entryField("Item ID", itemID_controller),
